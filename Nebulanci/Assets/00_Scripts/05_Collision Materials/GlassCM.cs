...
public class GlassCM : CollisionMaterials
{
    [Tooltip("Layer should be TransparentFX or your own layer for breakable windows.")]
    //[SerializeField] LayerMask transparentFX;
    [SerializeField] int bulletLayerMask;
    [Range(2, 25)]
    public int partsX = 5;
    [Range(2, 25)]
    public int partsY = 5;
    ...
    //[SerializeField] GameObject splinterParent;
    ...
    private List<Rigidbody> splintersRigidbodies = new();
    private List<Collider> splintersColliders = new();

    void Start()
    {
        //Debug.Log(bulletLayerMask);
        audioClip = AudioManager.audioList.cm_glass;
    ...
    private void GenerateSingleSplinter(int[] tris, Transform parent)
    {
        ...
        //obj.layer = transparentFX.value;
        obj.layer = bulletLayerMask;
        ...
        splintersRigidbodies.Add(rigid);
    ...
    private void BakeSplinters()
    {
        ...
        //splinterParent.layer = bulletLayerMask;
